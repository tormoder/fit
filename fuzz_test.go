...
// decoding them.
var goFuzzCrasherInputs = [...]string{
	// GpsMetaData is a known message number but there was no GpsMetaData
	// message definition.
	...
	// Field definition had different base type from the one listed in the
	// profile.
	"\x0e\x10W\x04\xdf\xdb\x01\x00.FIT\xc4\x1e@0\x00\x00\x00\x06" +
		"0\x04\x8c0\x04\x860\x02\x840\x02\x840\x02\x84\x00\x01\x0000" +
	...
	// Did not check for unknown message number during definition message
	// validation. Caused index out of range on profile lookup.
	"\x0e\x10W\x04\xdf\xdb\x01\x00.FIT\xc4\x1e@0\x00\x00\x00\x06" +
		"0\x04\x8c0\x04\x860\x02\x840\x02\x840\x02\x84\x00\x01\x0000" +
	...
	// Padding in parseDataFields was not reset on each iteration. No moved
	// inside loop and not possible.
	"\x0e\x10W\x04\xdf\xdb\x01\x00.FIT\xc4\x1e@0\x00\x00\x00\x06" +
	...
	// Field definition type was sint32 and profile was uint32. Only allow
	// compatible types that will not panic when setting using reflection.
	"\x0e\x10W\x04\xdf\xdb\x01\x00.FIT\xc4\x1e@0\x00\x00\x00\x06" +
		"\x03\x04\x8500\x8600\x8400\x8400\x8400\x0000" +
		"000",

	// Field definition type in profile was string, but field definition
	// type was enum. Both are unsigned, but not compatible.
	"\x0e\x10W\x04\xdf\xdb\x01\x00.FIT\xc4\x1e@0\x00\x00\x00\x06" +
		"0\x04\x8c0\x04\x860\x02\x840\x02\x840\x02\x84\b\x01\x0000" +
		"00000000000000",

	// Definition message field was string, but profile was not. Not
	// compatible types.
	"\x0e\x10W\x04\xdf\xdb\x01\x00.FIT\xc4\x1e@0\x00\x00\x00\x06" +
		"0\x04\x8c0\x04\x860\x02\x840\x02\x840\x02\x84\x00\x01\x0000" +
	...
	// Array profile field, but definition base type size was greater than
	// profile base type size.
	"\x0e\x10W\x04\xdf\xdb\x01\x00.FIT\xc4\x1e@0\x00\x00\x00\x06" +
		"0\x04\x8c0\x04\x860\x02\x840\x02\x840\x02\x84\x00\x01\x0000" +
	...
	// Allow only compatible types if definition base type size is less the
	// profile base type size.
	"\x0e\x10W\x04\xdf\xdb\x01\x00.FIT\xc4\x1e@0\x00\x00\x00\x06" +
		"0\x04\x8c0\x04\x860\x02\x840\x02\x840\x02\x84\x00\x01\x0000" +
