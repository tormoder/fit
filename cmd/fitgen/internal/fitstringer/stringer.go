...
// This is a fork of golang.org/x/tools/cmd/stringer used to generate string
// methods for the FIT types generated by cmd/fitgen. It is now a library
// instead of a command. It also has slightly different logic for prefix
// trimming.  compared to the original. This version will always remove the
// type name prefix for each generated type.
//
