...
const (
	...
	_FileType_name_7 = "MfgRangeMin"
	_FileType_name_8 = "MfgRangeMaxInvalid"
)
...
var (
	...
	_FileType_index_7 = [...]uint8{0, 11}
	_FileType_index_8 = [...]uint8{0, 11, 18}
)
...
func (i FileType) String() string {
	...
	case 254 <= i && i <= 255:
		i -= 254
		return _FileType_name_8[_FileType_index_8[i]:_FileType_index_8[i+1]]
	default:
